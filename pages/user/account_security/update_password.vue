<template>
  <view>
    <hx-navbar :status-bar="true" :fixed="true" defaultBackUrl="security" left-text="Configuración de contraseña">
...
import {updatePassword} from "../../../common/vmeitime-http/user";
...
export default {
  ...
  methods: {
    ...
    formSubmit(){
      ...
      //验证原密码
      that.$api.user.updatePassword({oldPwd: that.oldPwd,newPwd:that.newPwd}).then((res) => {
