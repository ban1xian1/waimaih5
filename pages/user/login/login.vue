    ...
    <view class="content">
      ...
      <view class="main">
        <wInput
            ...
            type="text"
            maxlength="30"
            placeholder="Cuenta / Móvil / Correo"
        ></wInput>
      ...
      ></wButton>
      <!-- 其他登录 -->
      <view class="other_login cuIcon" v-if="1==2">
      ...
      <!-- 底部信息 -->
      <view class="footer">
        <!--				<navigator url="../forget/forget" open-type="navigate">Has olvidado tu contraseña</navigator>-->
        <text @click="lianxiadmin">Has olvidado tu contraseña</text>
        <text>|</text>
        <text @click="go_register">Registro</text>
        <!--				<navigator url="../register/register" open-type="navigate">Registro</navigator>-->
      </view>
    </view>
  </view>
</template>
  ...
  methods: {
    ...
    go_register(){
      ...
      uni.showToast({
        icon: 'none',
        position: 'bottom',
        title: 'Por favor contacte al recepcionista'
      });
    },go_index(){
      uni.reLaunch({
        url: '/',
